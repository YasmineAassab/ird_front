...
@Component({
  selector: 'app-template-email-replanification-create-admin',
  templateUrl: './template-email-replanification-create-admin.component.html',
  styleUrls: ['./template-email-replanification-create-admin.component.css']
})
export class TemplateEmailReplanificationCreateAdminComponent implements OnInit {
