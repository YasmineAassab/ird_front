...
@Component({
  selector: 'app-etat-demande-kosc-create-admin',
  templateUrl: './etat-demande-kosc-create-admin.component.html',
  styleUrls: ['./etat-demande-kosc-create-admin.component.css']
})
export class EtatDemandeKoscCreateAdminComponent implements OnInit {
