...
@Component({
  selector: 'app-departement-technicien-create-admin',
  templateUrl: './departement-technicien-create-admin.component.html',
  styleUrls: ['./departement-technicien-create-admin.component.css']
})
export class DepartementTechnicienCreateAdminComponent implements OnInit {
...
public saveWithShowOption(showList: boolean){
    ...
    this.messageService.add({severity: 'error', summary: 'Erreurs',detail: 'Departement technicien existe déjà' });
    }
