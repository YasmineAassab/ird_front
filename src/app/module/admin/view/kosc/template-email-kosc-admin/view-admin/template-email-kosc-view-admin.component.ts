...
@Component({
  selector: 'app-template-email-kosc-view-admin',
  templateUrl: './template-email-kosc-view-admin.component.html',
  styleUrls: ['./template-email-kosc-view-admin.component.css']
})
export class TemplateEmailKoscViewAdminComponent implements OnInit {
