...
@Component({
  selector: 'app-template-email-kosc-edit-admin',
  templateUrl: './template-email-kosc-edit-admin.component.html',
  styleUrls: ['./template-email-kosc-edit-admin.component.css']
})
export class TemplateEmailKoscEditAdminComponent implements OnInit {
