...
@Component({
  selector: 'app-template-email-kosc-create-admin',
  templateUrl: './template-email-kosc-create-admin.component.html',
  styleUrls: ['./template-email-kosc-create-admin.component.css']
})
export class TemplateEmailKoscCreateAdminComponent implements OnInit {
