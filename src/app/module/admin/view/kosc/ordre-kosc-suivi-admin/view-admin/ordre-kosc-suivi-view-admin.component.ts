...
@Component({
  selector: 'app-ordre-kosc-suivi-view-admin',
  templateUrl: './ordre-kosc-suivi-view-admin.component.html',
  styleUrls: ['./ordre-kosc-suivi-view-admin.component.css']
})
export class OrdreKoscSuiviViewAdminComponent implements OnInit {
