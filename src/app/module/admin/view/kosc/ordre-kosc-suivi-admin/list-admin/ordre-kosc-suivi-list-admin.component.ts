...
@Component({
  ...
  templateUrl: './ordre-kosc-suivi-list-admin.component.html',
  styleUrls: ['./ordre-kosc-suivi-list-admin.component.css']
})
export class OrdreKoscSuiviListAdminComponent implements OnInit {
   // declarations
