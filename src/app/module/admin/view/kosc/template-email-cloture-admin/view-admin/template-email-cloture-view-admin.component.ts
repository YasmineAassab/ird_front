...
@Component({
  selector: 'app-template-email-cloture-view-admin',
  templateUrl: './template-email-cloture-view-admin.component.html',
  styleUrls: ['./template-email-cloture-view-admin.component.css']
})
export class TemplateEmailClotureViewAdminComponent implements OnInit {
