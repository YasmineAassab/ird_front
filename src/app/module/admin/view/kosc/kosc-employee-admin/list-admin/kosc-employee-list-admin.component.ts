...
@Component({
  selector: 'app-kosc-employee-list-admin',
  templateUrl: './kosc-employee-list-admin.component.html',
  styleUrls: ['./kosc-employee-list-admin.component.css']
})
export class KoscEmployeeListAdminComponent implements OnInit {
   // declarations
