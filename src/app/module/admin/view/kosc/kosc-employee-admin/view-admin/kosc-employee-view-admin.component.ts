...
@Component({
  selector: 'app-kosc-employee-view-admin',
  templateUrl: './kosc-employee-view-admin.component.html',
  styleUrls: ['./kosc-employee-view-admin.component.css']
})
export class KoscEmployeeViewAdminComponent implements OnInit {
