...
@Component({
  selector: 'app-kosc-employee-edit-admin',
  templateUrl: './kosc-employee-edit-admin.component.html',
  styleUrls: ['./kosc-employee-edit-admin.component.css']
})
export class KoscEmployeeEditAdminComponent implements OnInit {
