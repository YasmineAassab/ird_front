...
@Component({
  selector: 'app-arret-travail-edit-admin',
  templateUrl: './arret-travail-edit-admin.component.html',
  styleUrls: ['./arret-travail-edit-admin.component.css']
})
export class ArretTravailEditAdminComponent implements OnInit {
