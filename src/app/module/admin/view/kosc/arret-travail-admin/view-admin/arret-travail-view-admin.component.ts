...
@Component({
  selector: 'app-arret-travail-view-admin',
  templateUrl: './arret-travail-view-admin.component.html',
  styleUrls: ['./arret-travail-view-admin.component.css']
})
export class ArretTravailViewAdminComponent implements OnInit {
