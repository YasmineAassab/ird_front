...
@Component({
  selector: 'app-operator-create-admin',
  templateUrl: './operator-create-admin.component.html',
  styleUrls: ['./operator-create-admin.component.css']
})
export class OperatorCreateAdminComponent implements OnInit {
