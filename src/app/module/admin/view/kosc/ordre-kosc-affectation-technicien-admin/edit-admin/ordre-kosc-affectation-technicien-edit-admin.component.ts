...
@Component({
  selector: 'app-ordre-kosc-affectation-technicien-edit-admin',
  templateUrl: './ordre-kosc-affectation-technicien-edit-admin.component.html',
  styleUrls: ['./ordre-kosc-affectation-technicien-edit-admin.component.css']
})
export class OrdreKoscAffectationTechnicienEditAdminComponent implements OnInit {
