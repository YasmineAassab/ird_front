...
@Component({
  selector: 'app-ordre-kosc-affectation-technicien-view-admin',
  templateUrl: './ordre-kosc-affectation-technicien-view-admin.component.html',
  styleUrls: ['./ordre-kosc-affectation-technicien-view-admin.component.css']
})
export class OrdreKoscAffectationTechnicienViewAdminComponent implements OnInit {
