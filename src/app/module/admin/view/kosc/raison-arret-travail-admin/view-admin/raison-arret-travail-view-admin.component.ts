...
@Component({
  selector: 'app-raison-arret-travail-view-admin',
  templateUrl: './raison-arret-travail-view-admin.component.html',
  styleUrls: ['./raison-arret-travail-view-admin.component.css']
})
export class RaisonArretTravailViewAdminComponent implements OnInit {
