...
@Component({
  selector: 'app-template-email-report-view-admin',
  templateUrl: './template-email-report-view-admin.component.html',
  styleUrls: ['./template-email-report-view-admin.component.css']
})
export class TemplateEmailReportViewAdminComponent implements OnInit {
