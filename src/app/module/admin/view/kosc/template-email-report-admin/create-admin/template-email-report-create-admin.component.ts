...
@Component({
  selector: 'app-template-email-report-create-admin',
  templateUrl: './template-email-report-create-admin.component.html',
  styleUrls: ['./template-email-report-create-admin.component.css']
})
export class TemplateEmailReportCreateAdminComponent implements OnInit {
