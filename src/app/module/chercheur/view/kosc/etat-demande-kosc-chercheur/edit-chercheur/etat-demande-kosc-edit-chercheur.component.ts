...
@Component({
  selector: 'app-etat-demande-kosc-edit-chercheur',
  templateUrl: './etat-demande-kosc-edit-chercheur.component.html',
  styleUrls: ['./etat-demande-kosc-edit-chercheur.component.css']
})
export class EtatDemandeKoscEditChercheurComponent implements OnInit {
