...
@Component({
  selector: 'app-template-email-planification-view-chercheur',
  templateUrl: './template-email-planification-view-chercheur.component.html',
  styleUrls: ['./template-email-planification-view-chercheur.component.css']
})
export class TemplateEmailPlanificationViewChercheurComponent implements OnInit {
