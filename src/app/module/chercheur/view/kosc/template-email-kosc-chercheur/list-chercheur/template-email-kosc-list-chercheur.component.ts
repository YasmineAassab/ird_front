...
@Component({
  selector: 'app-template-email-kosc-list-chercheur',
  templateUrl: './template-email-kosc-list-chercheur.component.html',
  styleUrls: ['./template-email-kosc-list-chercheur.component.css']
})
export class TemplateEmailKoscListChercheurComponent implements OnInit {
   // declarations
