...
@Component({
  selector: 'app-template-email-client-injoinable-create-chercheur',
  templateUrl: './template-email-client-injoinable-create-chercheur.component.html',
  styleUrls: ['./template-email-client-injoinable-create-chercheur.component.css']
})
export class TemplateEmailClientInjoinableCreateChercheurComponent implements OnInit {
