...
@Component({
  selector: 'app-template-email-client-injoinable-edit-chercheur',
  templateUrl: './template-email-client-injoinable-edit-chercheur.component.html',
  styleUrls: ['./template-email-client-injoinable-edit-chercheur.component.css']
})
export class TemplateEmailClientInjoinableEditChercheurComponent implements OnInit {
