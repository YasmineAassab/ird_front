...
@Component({
  selector: 'app-kosc-employee-create-chercheur',
  templateUrl: './kosc-employee-create-chercheur.component.html',
  styleUrls: ['./kosc-employee-create-chercheur.component.css']
})
export class KoscEmployeeCreateChercheurComponent implements OnInit {
