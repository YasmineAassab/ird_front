...
@Component({
  selector: 'app-arret-travail-create-chercheur',
  templateUrl: './arret-travail-create-chercheur.component.html',
  styleUrls: ['./arret-travail-create-chercheur.component.css']
})
export class ArretTravailCreateChercheurComponent implements OnInit {
