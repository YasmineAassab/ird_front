...
@Component({
  selector: 'app-departement-technicien-edit-chercheur',
  templateUrl: './departement-technicien-edit-chercheur.component.html',
  styleUrls: ['./departement-technicien-edit-chercheur.component.css']
})
export class DepartementTechnicienEditChercheurComponent implements OnInit {
