...
@Component({
  selector: 'app-ordre-kosc-list-chercheur',
  templateUrl: './ordre-kosc-list-chercheur.component.html',
  styleUrls: ['./ordre-kosc-list-chercheur.component.css']
})
export class OrdreKoscListChercheurComponent implements OnInit {
   // declarations
