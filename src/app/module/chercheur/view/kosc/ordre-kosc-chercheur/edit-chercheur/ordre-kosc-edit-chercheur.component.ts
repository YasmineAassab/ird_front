...
@Component({
  selector: 'app-ordre-kosc-edit-chercheur',
  templateUrl: './ordre-kosc-edit-chercheur.component.html',
  styleUrls: ['./ordre-kosc-edit-chercheur.component.css']
})
export class OrdreKoscEditChercheurComponent implements OnInit {
