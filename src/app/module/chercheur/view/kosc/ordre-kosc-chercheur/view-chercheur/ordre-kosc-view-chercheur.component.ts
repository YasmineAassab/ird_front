...
@Component({
  selector: 'app-ordre-kosc-view-chercheur',
  templateUrl: './ordre-kosc-view-chercheur.component.html',
  styleUrls: ['./ordre-kosc-view-chercheur.component.css']
})
export class OrdreKoscViewChercheurComponent implements OnInit {
