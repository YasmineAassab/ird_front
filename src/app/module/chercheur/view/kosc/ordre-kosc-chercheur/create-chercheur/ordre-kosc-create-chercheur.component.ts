...
@Component({
  selector: 'app-ordre-kosc-create-chercheur',
  templateUrl: './ordre-kosc-create-chercheur.component.html',
  styleUrls: ['./ordre-kosc-create-chercheur.component.css']
})
export class OrdreKoscCreateChercheurComponent implements OnInit {
