...
@Component({
  selector: 'app-entreprise-view-chercheur',
  templateUrl: './entreprise-view-chercheur.component.html',
  styleUrls: ['./entreprise-view-chercheur.component.css']
})
export class EntrepriseViewChercheurComponent implements OnInit {
