...
@Component({
  selector: 'app-technicien-view-chercheur',
  templateUrl: './technicien-view-chercheur.component.html',
  styleUrls: ['./technicien-view-chercheur.component.css']
})
export class TechnicienViewChercheurComponent implements OnInit {
