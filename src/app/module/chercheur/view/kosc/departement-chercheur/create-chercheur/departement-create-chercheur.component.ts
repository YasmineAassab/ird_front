...
@Component({
  selector: 'app-departement-create-chercheur',
  templateUrl: './departement-create-chercheur.component.html',
  styleUrls: ['./departement-create-chercheur.component.css']
})
export class DepartementCreateChercheurComponent implements OnInit {
