...
@Component({
  selector: 'app-departement-list-chercheur',
  templateUrl: './departement-list-chercheur.component.html',
  styleUrls: ['./departement-list-chercheur.component.css']
})
export class DepartementListChercheurComponent implements OnInit {
   // declarations
