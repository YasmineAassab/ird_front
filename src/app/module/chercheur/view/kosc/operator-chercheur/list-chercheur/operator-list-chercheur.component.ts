...
@Component({
  selector: 'app-operator-list-chercheur',
  templateUrl: './operator-list-chercheur.component.html',
  styleUrls: ['./operator-list-chercheur.component.css']
})
export class OperatorListChercheurComponent implements OnInit {
   // declarations
