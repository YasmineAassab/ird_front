...
@Component({
  selector: 'app-operator-edit-chercheur',
  templateUrl: './operator-edit-chercheur.component.html',
  styleUrls: ['./operator-edit-chercheur.component.css']
})
export class OperatorEditChercheurComponent implements OnInit {
