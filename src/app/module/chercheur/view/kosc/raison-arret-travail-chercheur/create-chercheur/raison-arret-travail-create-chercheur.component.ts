...
@Component({
  selector: 'app-raison-arret-travail-create-chercheur',
  templateUrl: './raison-arret-travail-create-chercheur.component.html',
  styleUrls: ['./raison-arret-travail-create-chercheur.component.css']
})
export class RaisonArretTravailCreateChercheurComponent implements OnInit {
