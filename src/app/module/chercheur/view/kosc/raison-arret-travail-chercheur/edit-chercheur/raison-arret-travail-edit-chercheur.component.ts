...
@Component({
  selector: 'app-raison-arret-travail-edit-chercheur',
  templateUrl: './raison-arret-travail-edit-chercheur.component.html',
  styleUrls: ['./raison-arret-travail-edit-chercheur.component.css']
})
export class RaisonArretTravailEditChercheurComponent implements OnInit {
